 ...
 * math, which is made easy by the methods inside the <b>Vector2D</b>
 * class.<br />
 * <br />
 ...
 * exception of cross(), which returns a new Vector2D (or writes to a specified
 * 'target' Vector2D). That is, add() will add the contents of one vector to
 * this one. Using add() with additional parameters allows you to put the
 * result into a new Vector2D. Functions that act on multiple vectors also
 * include static versions. Because creating new objects can be computationally
 * expensive, most functions include an optional 'target' Vector2D, so that a
 * new Vector2D object is not created with each operation.
 * <p>
...
public class PVector {
  ...
  /**
   * ( begin auto-generated from Vector2D_x.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_y.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_z.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_set.xml )
   *
   * Sets the x, y, and z component of the vector using two or three separate
   * variables, the data from a Vector2D, or the values from a float array.
   *
   * ( end auto-generated )
   *
  ...
  /**
   * @param v any variable of type Vector2D
   */
  ...
  /**
   * ( begin auto-generated from Vector2D_random2D.xml )
   *
   ...
   * also pass in a target Vector2D to fill.
   *
   * @webref pvector:method
   * @usage web_application
   * @return the random Vector2D
   * @brief Make a new 2D unit vector with a random direction.
   * @see Vector2D#random3D()
   */
  ...
  /**
   * ( begin auto-generated from Vector2D_random3D.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_sub.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_mag.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_add.xml )
   *
   * Adds x, y, and z components to a vector, adds one vector to another, or
   * adds two independent vectors together. The version of the method that
   * adds two vectors together is a static method and returns a Vector2D, the
   ...
   * Vector2D, the others have no return value -- they act directly on the
   ...
   * @param v1 the x, y, and z components of a Vector2D object
   * @param v2 the x, y, and z components of a Vector2D object
   */
   ...
   * @param v1 the x, y, and z components of a Vector2D object
   * @param v2 the x, y, and z components of a Vector2D object
   * @param target Vector2D in which to store the result
   */
  ...
  /**
   * ( begin auto-generated from Vector2D_mult.xml )
   *
  ...
  /**
   * Multiply a vector by a scalar, and write the result into a target Vector2D.
   * @param target Vector2D in which to store the result
   */
  ...
  /**
   * ( begin auto-generated from Vector2D_div.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_dist.xml )
   *
   ...
   * @webref pvector:method
   * @usage web_application
   * @param v the x, y, and z coordinates of a Vector2D
  ...
  /**
   * ( begin auto-generated from Vector2D_dot.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_cross.xml )
   *
  ...
  /**
   * @param v any variable of type Vector2D
   * @param target Vector2D to store the result
   */
  ...
  /**
   * ( begin auto-generated from Vector2D_normalize.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_limit.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_setMag.xml )
   *
  ...
  /**
   * ( begin auto-generated from Vector2D_rotate.xml )
   *
  ...
  /**
   * Linear interpolate between two vectors (returns a new Vector2D object)
  ...
  /**
   * ( begin auto-generated from Vector2D_angleBetween.xml )
   *
   ...
   * @webref pvector:method
   * @usage web_application
   * @param v1 the x, y, and z components of a Vector2D
   * @param v2 the x, y, and z components of a Vector2D
  ...
  /**
   * ( begin auto-generated from Vector2D_array.xml )
   *
   * Return a representation of this vector as a float array. This is only
   * for temporary use. If used in any other fashion, the contents should be
   * copied by using the <b>Vector2D.get()</b> method to copy into your own array.
   *
   * ( end auto-generated )
   *
   * @webref pvector:method
